...
app = Flask(__name__, template_folder=r'C:\Users\avant\OneDrive\Desktop\Ai\Template')
CORS(app)  # Enable CORS for frontend integration

# Load the saved model and vectorizers
with open(r'C:\Users\avant\OneDrive\Desktop\Ai\Model\disease_prediction_model.pkl', 'rb') as f:
    model = pickle.load(f)  
with open(r'C:\Users\avant\OneDrive\Desktop\Ai\Model\tfidf_vectorizer.pkl', 'rb') as f:
    tfidf = pickle.load(f)
with open(r'C:\Users\avant\OneDrive\Desktop\Ai\Model\disease_encoder.pkl', 'rb') as f:
    le_disease = pickle.load(f)
with open(r'C:\Users\avant\OneDrive\Desktop\Ai\Model\gender_encoder.pkl', 'rb') as f:
    le_gender = pickle.load(f)
with open(r'C:\Users\avant\OneDrive\Desktop\Ai\Model\disease_mapping.json', 'r') as f:
    disease_mapping = json.load(f)

# Load precaution data
precaution_df = pd.read_csv(r'C:\Users\avant\OneDrive\Desktop\Ai\dataset\precaution_updated_with_lifestyle.csv')
...
desc_df = pd.read_csv(r"C:\Users\avant\OneDrive\Desktop\Ai\dataset\Modified_Symptom_Description_with_PatientInfo.csv")
